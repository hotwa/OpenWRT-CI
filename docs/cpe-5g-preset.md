...
## 2026-07-12 mwan3 构建门禁

- 实现经 PR [#13](https://github.com/hotwa/OpenWRT-CI/pull/13) 普通 merge 进入 main `13c984d70139436205177f0a8640a29d87787e5c`；实现分支已在 ancestry 验证后删除。
- TEST=true run [`29203906558`](https://github.com/hotwa/OpenWRT-CI/actions/runs/29203906558) 成功，B 配置包含 mwan3/LuCI mwan3，A 正确跳过；约 50 KB artifact 是预期配置包，不是固件。
- 最终 main 的 TEST=false run [`29204310241`](https://github.com/hotwa/OpenWRT-CI/actions/runs/29204310241) 成功。artifact `8264724224` 大小 `416,207,857` 字节，ZIP SHA256 为 `f5b40733961930b145e3c4278f46013018b27e29c0be70cbb22ad856397455b9`。
- factory 大小 `212,885,673` 字节，SHA256 `94a062d54846f5b4bf32114da99377421f8538bd268a42d228136a1a1e899aba`；sysupgrade 大小 `208,107,792` 字节，SHA256 `7b8c9b2f66ea67898535129d316837a9293cd35665e7b87fb517b098d8fceb78`。`SHA256SUMS` 全部通过。
- metadata 确认 `0bad892...`、`IPQ60XX-706-NOWIFI`、`jdcloud_re-ss-01`、`feature_overlay=true`；manifest 包含 mwan3 2.12.1、firewall4、iptables-nft/ip6tables-nft、xtables-nft、kmod-nft-compat、Nikki 和 Lucky。
- 产物已下载到仓库外的 `C:\Users\pylyz\Downloads\OpenWRT-CI-CPE5G-29204310241`。本轮未自动刷机；真实 WAN 拔线、Nikki fwmark 和 SIM 计数仍必须在独立本地救援与定时回滚条件满足后验证。
