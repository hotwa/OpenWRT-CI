...
# OpenClaw is intentionally isolated to its named target. General device
# builds retain the agent runtime, but neither fetch nor package OpenClaw.
if [ "${WRT_OPENCLAW:-false}" = "true" ]; then
