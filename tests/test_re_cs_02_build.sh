...
for term in 're_cs_02:' 'WRT_CONFIG: IPQ60XX-RE-CS-02' 'WRT_EXPECTED_DEVICE: jdcloud_re-cs-02' 'WRT_REQUIRED_DEVICE: jdcloud_re-cs-02' 'WRT_EMMC_DATA_PROVISIONING: true' 'WRT_BUILD_ONLY: true'; do
