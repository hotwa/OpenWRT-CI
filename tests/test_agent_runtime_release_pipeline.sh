...
for term in 'AGENT_RUNTIME_USIGN_SECRET_KEY' 'files/etc/agent-runtime/usign.pub' 'qemu-user-static' 'cmdc --version' 'Sign index and manifests' 'verify_pi_extensions.js' 'verify_pi_extension_conflicts.js' '@napi-rs/keyring' 'zigpty' 'candidate-release' 'Compare verified latest candidate with stable channel' 'input_sha256'; do
